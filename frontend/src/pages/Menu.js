                            ...
                            <Grid container>
                                <Grid item xs={2} sx={{display:'flex', justifyContent:'center', mb:4}}>
                                    <Box>
                                        <Box sx={{position:'absolute', mt:28.5, width:165, display:'flex', justifyContent:'center'}}>
                                            <Button sx={{backgroundColor:'primary.main', border:1, borderColor:'text.primary', 
                                            py:0, px:2}} startIcon={<ShoppingCartOutlinedIcon />} style={TyStyD4SS9}
                                            variant="contained">$89</Button>
                                        </Box>

                                        <Box sx={{backgroundColor:'secondary.secondary', borderRadius:1,  width:150, height:213,
                                        textAlign:'center', px:1, py:1.5}} className='cardMenu'>
                                            <Box sx={{width:'100%', display:'flex', justifyContent:'center'}}>
                                                <Image src={FrutaPasion} fit='cover' duration={0} height={140} width={140}/>
                                            </Box>
                                            <Typography style={TyStyD5P9}>Fruta Pasión</Typography>
                                            <Typography style={TyStyD2P6} sx={{lineHeight:1.1}}>
                                                Delicia citrica elaborada con autenticos trozos de frutos secos
                                                (350ml)
                                            </Typography>
                                        </Box>
                                    </Box>
                                ...
                                <Grid item xs={2} sx={{display:'flex', justifyContent:'center', mb:4}}>
                                    <Box>
                                        ...
                                        textAlign:'center', px:1, py:1.5}} className='cardMenu'>
                                            <Box sx={{width:'100%', display:'flex', justifyContent:'center'}}>
                                                <Image src={Jazmin} fit='cover' duration={0} height={140} width={140}/>
                                            </Box>
                                            <Typography style={TyStyD5P9}>Jazmín</Typography>
                                            <Typography style={TyStyD2P6} sx={{lineHeight:1.1}}>
                                                Aromaticas hojas de Jazmín, un sabor suave y fresco para cualquier
                                                hora del día (350ml).
                                            </Typography>
                                        </Box>
                                    </Box>
                                ...
                                <Grid item xs={2} sx={{display:'flex', justifyContent:'center', mb:4}}>
                                    <Box>
                                        <Box sx={{position:'absolute', mt:28.5, width:165, display:'flex', justifyContent:'center'}}>
                                            <Button sx={{backgroundColor:'primary.main', border:1, borderColor:'text.primary', 
                                            py:0, px:2}} startIcon={<ShoppingCartOutlinedIcon />} style={TyStyD4SS9}
                                            variant="contained">$105</Button>
                                        </Box>

                                        <Box sx={{backgroundColor:'secondary.secondary', borderRadius:1,  width:150, height:213,
                                        textAlign:'center', px:1, py:1.5}} className='cardMenu'>
                                            <Box sx={{width:'100%', display:'flex', justifyContent:'center'}}>
                                                <Image src={NegroFR} fit='cover' duration={0} height={140} width={140}/>
                                            </Box>
                                ...
                                <Grid item xs={2} sx={{display:'flex', justifyContent:'center', mb:4}}>
                                    <Box>
                                        ...
                                        textAlign:'center', px:1, py:1.5}} className='cardMenu'>
                                            <Box sx={{width:'100%', display:'flex', justifyContent:'center'}}>
                                                <Image src={Oolong} fit='cover' duration={0} height={140} width={140}/>
                                            </Box>
                                            <Typography style={TyStyD5P9}>Oolong Toronja</Typography>
                                            <Typography style={TyStyD2P6} sx={{lineHeight:1.1}}>
                                                Mezcla de la casa, especias y cítricos. Perfecta para comenzar el día
                                                (260ml)
                                            </Typography>
                                        </Box>
                                    </Box>
                            ...
                            <Grid container>
                                <Grid item xs={2} sx={{display:'flex', justifyContent:'center', mb:4}}>
                                    <Box>
                                        <Box sx={{position:'absolute', mt:28.5, width:165, display:'flex', justifyContent:'center'}}>
                                            <Button sx={{backgroundColor:'primary.main', border:1, borderColor:'text.primary', 
                                            py:0, px:2}} startIcon={<ShoppingCartOutlinedIcon />} style={TyStyD4SS9}
                                            variant="contained">$115</Button>
                                        </Box>

                                        <Box sx={{backgroundColor:'secondary.secondary', borderRadius:1,  width:150, height:213,
                                        textAlign:'center', px:1, py:1.5}} className='cardMenu'>
                                            <Box sx={{width:'100%', display:'flex', justifyContent:'center'}}>
                                                <Image src={FrappeC} fit='cover' duration={0} height={140} width={140}/>
                                            </Box>
                                ...
                                <Grid item xs={2} sx={{display:'flex', justifyContent:'center', mb:4}}>
                                    <Box>
                                        ...
                                        textAlign:'center', px:1, py:1.5}} className='cardMenu'>
                                            <Box sx={{width:'100%', display:'flex', justifyContent:'center'}}>
                                                <Image src={FrappeCT} fit='cover' duration={0} height={140} width={140}/>
                                            </Box>
                                ...
                                <Grid item xs={2} sx={{display:'flex', justifyContent:'center', mb:4}}>
                                    <Box>
                                        ...
                                        textAlign:'center', px:1, py:1.5}} className='cardMenu'>
                                            <Box sx={{width:'100%', display:'flex', justifyContent:'center'}}>
                                                <Image src={FrappeT} fit='cover' duration={0} height={140} width={140}/>
                                            </Box>
                                            <Typography style={TyStyD5P9}>Taro</Typography>
                                            <Typography style={TyStyD2P6} sx={{lineHeight:1.1}}>
                                                Bebida dulce a base de leche y con el sabor puro de la raiz Taro
                                                (500ml).
                                            </Typography>
                                        </Box>
                                    </Box>
